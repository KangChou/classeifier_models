...
if __name__ == '__main__':
    # 不用提前建文件夹，不然会出错
    src_data_folder = "./golds/train/"
    target_data_folder = "./golds_and_monkey2"

    train_path = target_data_folder+'/train/'
    validation_path = target_data_folder+'/validation/'
    test_path = target_data_folder+'/test/'
    # mkTotalDir(src_data_folder)
    divideTrainValidationTest(src_data_folder, train_path, validation_path, test_path)
